...
<nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
   ...
   <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
     ...
     <li class="nav-item active">
         <a class="nav-link" href="ManterUsuarios.php" onclick='location.replace("ManterUsuarios.php")'>voltar</a>
       </li>
       <li class="nav-item">
         <a class="nav-link" href="ManterUsuarios.php?saida=1" onclick='location.replace("../login.html")'>Sair</a>
       </li>   
     </ul>   
   </div>
 </nav>  
...
<form name="cadastrar" method="post" action="CadastrarUsuario.php" id="CadastrarUsuario" onsubmit="validaFormUsuario(); return false;">
